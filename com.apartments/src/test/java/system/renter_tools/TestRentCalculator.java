...
public class TestRentCalculator extends BasePage {
    ...
    public void testFindRentals(String monthlyIncome, String incomePercentage, String location, String priceRange) {
        ...
        Assert.assertEquals(searchResultsPage.getRentalPriceRangeText(), priceRange);
    }
}
